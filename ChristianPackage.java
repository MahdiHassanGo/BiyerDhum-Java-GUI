...
public class ChristianPackage extends JFrame implements ActionListener
{
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10;
		...
		public void actionPerformed(ActionEvent ae)
		{
			...
			{
				JOptionPane.showMessageDialog(null, "Total Cost : 600000tk" , "BiyerDhum!",
		...
		{
			ChristianPackage p = new ChristianPackage();
			p.show();
